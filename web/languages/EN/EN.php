...
define('LANG_menu_ADDMODULE', 'New Rack');
define('LANG_menu_ADDROW', 'New Row');
...
define('LANG_settings_ADDUSER_MSG',"Here you can add new users to RPiPWRManagement");
...
define('LANG_settings_USERS_MSG',"Here you can other users who can access to this RPiPWRManagement system and delete them");
...
define('LANG_module_DESCRIPTION', 'Rack Description');
define('LANG_module_IRRIG_LAST', 'Last power off');
define('LANG_module_IRRIG_NEXT', 'Next power off');
define('LANG_module_IRRIG_PLAN', 'Power Management Plan');
define('LANG_module_IRRIGS_LAST', 'Last operationss');
define('LANG_module_IRRIGS', 'Power off');
define('LANG_module_VIEWALL', 'View All');
define('LANG_module_SETTINGS', 'Rack settings');
define('LANG_module_NAME', 'Name');
define('LANG_module_EDIT', 'Edit');
define('LANG_module_BACK', 'Back');
define('LANG_module_IRRIGATION','Power off');
define('LANG_module_MANUALIRRIGATION','Manual Power off');
define('LANG_module_PLANNEDIRRIGATION','Planned Power off');
define('LANG_module_RAIN','Rain');
define('LANG_module_DATE','Date');
define('LANG_module_TYPE','Type');
define('LANG_module_NOIRRIGYET', 'This rack has never been turned off yet');
...
define('LANG_module_LITERS','Hours');
define('LANG_module_LITERS_SHORT','h.');
define('LANG_module_INTERVAL','Interval');
define('LANG_module_ADDEVENT','New Power off');
define('LANG_module_QUANTITYTOGIVE','Hours for every power off');
define('LANG_module_STARTINGFROM','Starting from');
define('LANG_module_IRRIGATEEVERY','Power off every');
...
define('LANG_module_DELETE_BTN', "Delete Rack");
...
define('LANG_row_NAME', 'Name');
define('LANG_row_DESCRIPTION', 'Row Description');
define('LANG_row_SETTINGS', 'Row Settings');
define('LANG_row_DELETE_BTN', "Delete Row");
define('LANG_row_EDIT', 'Modify');

define('LANG_rownew_ERR1', "Please fill up the Name field");
define('LANG_rownew_ERR2', "Please fill up the Description field");
define('LANG_rownew_IMAGEFILE', 'Image File');
define('LANG_rownew_IMAGE_LOGODEFAULT', "If you don't upload any image, default will be used");
define('LANG_rownew_BANNER', "New Row succesfully added");
