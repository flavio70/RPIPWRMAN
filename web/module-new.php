...
if(isset($_POST['name'])&&isset($_POST['description'])&&isset($_POST['gpio'])&&isset($_POST['throughtput']) ){
  $db->query_module_add($_POST['name'],$_POST['description'],$_POST['gpio'],$_POST['throughtput'],$_FILES['image'],$currRowID);
                ...
                <div class="panel-body">
                  <form name="frmNewModule" class="form-horizontal" method="post" action="" style="width:50%;margin:auto" 
                    ...
                    <fieldset id="fsStep2" style="display:none">
                      ...
                      <input id="txtThroughtput" type="hidden" name="throughtput" type="text" value="<?php echo LANG_module_THROUGHTPUT_VALUE ?>" class="form-control">
                      <div class="form-group">
